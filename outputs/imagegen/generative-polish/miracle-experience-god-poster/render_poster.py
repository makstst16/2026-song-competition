...
def build():
    ...
    draw.text((181, 88), "中華傳道會基石堂", font=font(31), fill=dark)
    draw.text((181, 126), "主辦  ·  ORGANISER", font=font(16, light=True), fill=muted)

    pill(draw, (MARGIN, 202, W - MARGIN, 266), "2026  歌唱比賽  ×  詩歌創作比賽", (19, 113, 122, 238), white, font(27))
    ...
    draw = ImageDraw.Draw(bg)
    draw.ellipse((472, 357, 488, 373), fill=gold)
    draw_spark(draw, 480, 365, 17, (233, 171, 64, 165))
    center_text(draw, (W / 2, 457), "MIRACLE  ·  EXPERIENCE GOD", font(21), teal)
    draw.rounded_rectangle((370, 492, 710, 498), radius=3, fill=gold)
    center_text(draw, (W / 2, 552), "透過音樂的恩典  ·  用歌聲見證神蹟", font(38), dark)
    ...
    events = [
        (886, "06—10月", "開放收集參與作品"),
        (1008, "11—12月", "所有弟兄姊妹投票，選出優秀作品"),
        (1130, "2027.01", "得獎作品於感恩音樂會演繹及分享"),
    ]
    for idx, (y, date, desc) in enumerate(events):
        ...
        draw.text((205, y - 31), date, font=font(35), fill=dark)
    ...
    draw.text((W - 110, 1462), "2027 年 1 月  ·  現場演繹與分享", font=font(24, light=True), fill=(220, 247, 239, 255), anchor="ra")
    ...
    draw.text((112, 1717), "作品徵集｜2026 年 6 月至 10 月", font=font(25), fill=teal)
    ...
    center_text(draw, (W / 2, 1883), "9:16 VERTICAL POSTER", font(13, light=True), (46, 112, 117, 210))
